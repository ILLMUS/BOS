  ...
  public: {
    Tables: {
      ...
      campaign_scheduled_sends: {
        ...
        Relationships: [
          {
            foreignKeyName: "campaign_scheduled_sends_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_campaign_id_fkey"
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "campaigns"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
            referencedRelation: "contacts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_scheduled_sends_step_id_fkey"
            columns: ["step_id"]
            isOneToOne: false
      ...
      campaign_send_audit: {
        ...
        Relationships: [
          {
            foreignKeyName: "campaign_send_audit_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "campaign_send_audit_send_id_fkey"
            columns: ["send_id"]
            isOneToOne: false
            referencedRelation: "campaign_scheduled_sends"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      client_approvals: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "client_approvals_stage_id_fkey"
            columns: ["stage_id"]
            isOneToOne: false
      ...
      document_sync_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_sync_status_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "jobs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "document_sync_status_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_org_admin_for_job: { Args: { _job_id: string }; Returns: boolean }
      is_org_member: { Args: { _org_id: string }; Returns: boolean }
      is_stage_owner: { Args: { _stage_id: string }; Returns: boolean }
      job_authority: { Args: { _job_id: string }; Returns: number }
      job_file_job_id: { Args: { _name: string }; Returns: string }
      ...
      notify_finance_mismatch: {
        Args: { _job_id: string; _message: string; _title: string }
        Returns: number
      }
      notify_quote_event: {
        Args: {
      ...
      org_authority: { Args: { _org_id: string }; Returns: number }
      read_email_batch: {
      ...
      seed_chart_of_accounts: { Args: { _org_id: string }; Returns: number }
      setup_workspace: {
        Args: {
          _description?: string
      ...
      stage_needs_client_approval: { Args: { _name: string }; Returns: boolean }
      submit_capture_form: {
