...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Scheduled Follow-ups", icon: Timer, to: "/outreach/follow-ups" },
      { label: "Follow-up Results", icon: FileBarChart, to: "/outreach/results" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Jobs / Projects", icon: Briefcase, to: "/jobs", count: "jobs" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Growth Reports", icon: FileBarChart, to: "/admin/reports", adminOnly: true },
    ],
  },
  {
    label: "Management",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Business Teams", icon: UsersRound, to: "/admin/teams", adminOnly: true },
      { label: "Roles & Step Owners", icon: UsersRound, to: "/admin/roles", adminOnly: true },
      { label: "Business Configuration", icon: SlidersHorizontal, to: "/admin/configuration", adminOnly: true },
      { label: "Recovery Centre", icon: History, to: "/recovery" },
...
export const ROUTE_TITLES: { path: string; title: string; subtitle: string }[] = [
  ...
  { path: "/outreach/follow-ups", title: "Scheduled Follow-ups", subtitle: "Review, approve or cancel queued WhatsApp messages." },
  { path: "/outreach/results", title: "Follow-up Results", subtitle: "Outcomes, response rates and unresolved leads." },
  ...
  { path: "/admin/roles", title: "Roles & Step Owners", subtitle: "Who is responsible for each stage." },
  { path: "/admin/teams", title: "Business Teams", subtitle: "Assign the people who run acquisition, sales and finance." },
