 ...
 * edit and send the quote. Approving or rejecting the step stays with the
 * assignee, managers and the board (enforced server-side by
 * guard_stage_approval_fields).
 */
export function canEditQuoteStage(
