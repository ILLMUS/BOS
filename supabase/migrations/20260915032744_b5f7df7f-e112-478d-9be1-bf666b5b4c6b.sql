...
DECLARE
  ...
  _ref text; _ext text; _status text; _due date; _url text; _issued date; _existing uuid;
BEGIN
  ...
  SELECT id INTO _existing FROM finance_documents WHERE org_id = _job.org_id AND external_id = _ext;
